...
class Link(BaseModel):
    ...
    item_language_count: StrictInt = Field(alias="itemLanguageCount")
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "websiteHost", "websiteName", "relativeReference", "itemLanguageCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "itemLanguageCount": obj.get("itemLanguageCount")
        })
        return _obj
