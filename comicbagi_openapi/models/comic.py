...
class Comic(BaseModel):
    ...
    code: StrictStr
    destination_link_count: StrictInt = Field(alias="destinationLinkCount")
    chapter_count: StrictInt = Field(alias="chapterCount")
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "code", "destinationLinkCount", "chapterCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "destinationLinkCount": obj.get("destinationLinkCount"),
