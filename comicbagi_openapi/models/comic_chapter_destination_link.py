...
class ComicChapterDestinationLink(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "updatedAt", "ulid", "linkWebsiteHost", "linkWebsiteName", "linkRelativeReference", "releasedAt"]
